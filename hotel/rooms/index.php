...
<div class="container">
    ...
    <h2 class="carousel-title">СТАНДАРТ</h2>
    <br>
    <div class="carousel">
        <div class="carousel-inner">
            <div class="carousel-item">
                <img src="../image/standart1.jpg" alt="Image 1">
                <div class="carousel-caption">СТАНДАРТ</div>
            </div>
            <div class="carousel-item">
                <img src="../image/standart2.jpg" alt="Image 2">
                <div class="carousel-caption">СТАНДАРТ</div>
            </div>
            <div class="carousel-item">
                <img src="../image/standart3.jpg" alt="Image 3">
                <div class="carousel-caption">СТАНДАРТ</div>
            </div>
        </div>
